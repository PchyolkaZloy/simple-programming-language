...
public:
  ...
  enum {
    ...
    RuleReturnStatement = 16, RuleExpression = 17, RulePrimaryExpression = 18, 
    RuleArrayInit = 19, RuleStructInit = 20, RuleArgumentList = 21, RuleFieldAccess = 22, 
    RuleArrayAccess = 23, RuleFunctionCall = 24, RuleAssignable = 25
  };
