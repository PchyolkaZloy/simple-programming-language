...
struct Int : public BaseType {
    ...
    IntOperatorTemplate(const BaseType &other, cpp_int (*op)(const cpp_int &, const cpp_int &)) const;

    std::shared_ptr<BaseType>
    DoubleOperatorTemplate(const BaseType &other, DoubleType (*op)(const DoubleType &, const DoubleType &)) const;

    std::shared_ptr<BaseType>
    BoolOperatorTemplate(const BaseType &other, cpp_int (*op)(const cpp_int &, const cpp_int &)) const;
    ...
    std::shared_ptr<Bool>
    IntCompareOperatorTemplate(const BaseType &other, BoolType (*op)(const IntType &, const IntType &)) const;

    std::shared_ptr<Bool>
    DoubleCompareOperatorTemplate(const BaseType &other, BoolType (*op)(const DoubleType &, const DoubleType &)) const;
...
struct Double : public BaseType {
    ...
    std::shared_ptr<BaseType>
    OperatorTemplate(const BaseType &other, DoubleType (*op)(const DoubleType &, const DoubleType &)) const;
...
#define DefDoubleOperator(op)                                                                                      \
    ...
    std::shared_ptr<Bool>
    CompareOperatorTemplate(const BaseType &other, BoolType (*op)(const DoubleType &, const DoubleType &)) const;

    std::shared_ptr<Bool> operator==(const BaseType &other) const override {
        if (auto res = CompareOperatorTemplate(other, [](const DoubleType &l, const DoubleType &r) {
            return abs(l - r) < EPS;
        })) {
            return res;
        }
...
struct Array : public BaseType {
    ...
    std::shared_ptr<Bool> CompareOperatorTemplate(const BaseType &other,
                                                  BoolType (*op)(const std::shared_ptr<BaseType> &,
                                                                 const std::shared_ptr<BaseType> &)) const;

    std::shared_ptr<Bool> operator==(const BaseType &other) const override {
        auto op = [](const std::shared_ptr<BaseType> &l, const std::shared_ptr<BaseType> &r) {
            return (*l == *r)->BoolCast();
        };
